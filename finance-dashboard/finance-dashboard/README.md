...
|---|---|---|
| Summary cards (Balance, Income, Expense) | ✅ | Dashboard → SummaryCards |
| Time-based visualization | ✅ | Dashboard → BarChart (monthly) |
| Categorical visualization | ✅ | Dashboard → DonutChart |
| Transaction list with details | ✅ | Transactions page |
| Filtering | ✅ | Type, Category, Date Range |
| Search | ✅ | Real-time with debounce |
| Sorting | ✅ | All columns, asc/desc |
| Role-based UI (Viewer/Admin) | ✅ | Sidebar dropdown |
| Insights section | ✅ | Dedicated Insights page |
| State management | ✅ | useReducer + Context |
| Responsive design | ✅ | Mobile sidebar, fluid grids |
| Empty state handling | ✅ | All components |
| Dark mode | ✅ | CSS variables |
| Data persistence | ✅ | localStorage |
| Export functionality | ✅ | CSV + JSON |
| Animated numbers | ✅ | useAnimateNumber hook |
...
This project was built as a frontend assignment to demonstrate React concepts in a real-world context. The focus was on:

1. **Clean architecture** — separation of data, logic, and UI
2. **Thoughtful UX** — debounced search, animated numbers, hover tooltips, toast feedback
3. **Real React patterns** — custom hooks, context, memoization — not just useState everywhere
4. **Zero dependencies** for UI — proves understanding of the fundamentals

If you want to reset all data and start fresh, open browser DevTools → Application → Local Storage → clear all `fd_*` keys and refresh.
